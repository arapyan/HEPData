...
#histo_Bck_Fig4 = reader_Fig4.read_hist_1d("hBck")
...
#totalbackground_Fig4 = Variable("Number of background events/GeV", is_independent=False, is_binned=False, units="")
#totalbackground_Fig4.values = histo_Bck_Fig3a["y"]

#unc_totalbackground_Fig4 = Uncertainty("total uncertainty", is_symmetric=True)
#unc_totalbackground_Fig4.values = histo_Bck_Fig3a["dy"]
...
#tableFig4.add_variable(totalbackground_Fig3a)
